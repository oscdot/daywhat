...
import { useSessionId } from '@/components/providers/session-provider'

export function useQuery<
  Args extends { sessionId: string | null },
  Query extends FunctionReference<'query', 'public', Args>,
>(query: Query, args: Omit<Query['_args'], 'sessionId'>): Query['_returnType'] | undefined {
...
>(
  mutation: Mutation,
): ReactMutation<FunctionReference<'mutation', 'public', Omit<Mutation['_args'], 'sessionId'>>> {
